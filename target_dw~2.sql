...
CREATE TABLE dim_product_dw (
    ...
    unit_of_measure       VARCHAR2(50),
    unit_price            NUMBER(10,2) NOT NULL,
    business_stage        VARCHAR2(50) NOT NULL
);
...
select count(*) from fact_sales_dw;
select * from dim_product_dw;

drop table dim_store_dw;
drop table dim_store_chain_dw;
drop table dim_category;
drop table dim_sub_category;
drop table dim_manufacturer;
drop table dim_product_dw;
drop table dim_distributor_dw;
drop table dim_date_dw;
drop table fact_sales_dw;

select * from fact_sales_dw;
select * from dim_store_dw;

TRUNCATE TABLE fact_sales_dw;
TRUNCATE TABLE dim_date_dw;
TRUNCATE TABLE dim_store_dw;
TRUNCATE TABLE dim_product_dw;
TRUNCATE TABLE dim_distributor_dw;
TRUNCATE TABLE dim_store_chain_dw;
